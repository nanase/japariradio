...
extern const uint16_t RDA5807M_BandLowerLimits[];
extern const uint16_t RDA5807M_BandHigherLimits[];
extern const uint8_t RDA5807M_ChannelSpacings[];
...
class RDA5807M {
 public:
   ...
   */
  RDA5807M(I2C_HandleTypeDef* dev);
